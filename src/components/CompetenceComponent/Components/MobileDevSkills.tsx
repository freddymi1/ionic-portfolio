...
import { FaAndroid, FaChevronRight } from 'react-icons/fa';
import {MobileSkills} from '../../../assets/data/data'
export const MobileDevSkills: React.FC = ()=> {
    ...
    MobileSkills.map((item: any, index: any)=>{
                   ...
                   <div className="cardSkills1Titlt" onClick={()=> toggleAccordion()}>
                        <div className="_headerSk">
                            <div className="box_icon">
                                <FaAndroid className="iconSkills"/>
                            </div>
