...
import { FaChevronRight, FaGit } from 'react-icons/fa';
import {OtherSkills} from '../../../assets/data/data'
export const AutresSkills: React.FC = ()=> {
    ...
    OtherSkills.map((item: any, index: any)=>{
