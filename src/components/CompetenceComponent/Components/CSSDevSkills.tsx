...
import { FaChevronRight, FaSass } from 'react-icons/fa';
import {CssSkills} from '../../../assets/data/data'
export const CSSDEVSkills: React.FC = ()=> {
    ...
    CssSkills.map((item: any, index: any)=>{
